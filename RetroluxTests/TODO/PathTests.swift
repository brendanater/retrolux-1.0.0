...
//        var request = builder.make(.get, ("users/{id}/"), Path("id"), response: Void.self)
...
//    func testThreePaths() {
//        let builder = makeTestBuilder()
//        let request = builder.make(.get, ("users/{3}/{1}/{2}/"), (Path("1"), Path("2"), Path("3")), response: Void.self)
...
//        let builder = makeTestBuilder()
//        var request = builder.make(.get, ("users/?id={id}"), Path("id"), response: Void.self)
